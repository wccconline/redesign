...
const MissionariesPage: React.FC = () => {
  ...
  const missionaries: Missionary[] = [
    ...
    },
    {
      ...
      description: {
        en: "Barry and Rachel Baggott grew up at the Webb Chapel Church of Christ, married, decided to be missionaries, and went away for training. They specialized in teaching the French speaking world. They worked together diligently around the globe until Rachel's death in late 2017. They worked extensively in West African countries such as Morocco, Republic of Congo, Ivory Coast, Burundi, Chad, and many others. They also taught the French speaking people of the South Pacific and Polynesia. Barry continues to work with the French-speaking peoples of East Africa, Polynesia, and the Pacific Islands. He actively develops and produces new materials in French and visits those locals to encourage, train, and teach people in person. Barry currently lives in Nashville, Tennessee. We started supporting their work many many years ago.",
        es: "Barry y Rachel Baggott crecieron en la iglesia de Cristo de Webb Chapel, se casaron, decidieron ser misioneros y se fueron a recibir capacitación. Se especializaron en enseñar al mundo francófono. Trabajaron juntos con diligencia alrededor del mundo hasta la muerte de Rachel a finales de 2017. Trabajaron extensamente en países de África Occidental como Marruecos, la República del Congo, Costa de Marfil, Burundi, Chad y muchos otros. También enseñaron a los francófonos del Pacífico Sur y de la Polinesia. Barry continúa trabajando con los pueblos francófonos de África Oriental, la Polinesia y las Islas del Pacífico. Desarrolla y produce activamente nuevos materiales en francés y visita a esas personas en sus lugares para animarlas, capacitarlas y enseñarles en persona. Barry vive actualmente en Nashville, Tennessee. Comenzamos a apoyar su labor hace muchísimos años.",
      },
